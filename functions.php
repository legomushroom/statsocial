...
function acitpo_comment($comment, $args, $depth) {
	...
	case 'trackback': ?>
		...
		<?php break;
	default: global $post; ?>		
		<div class="press-comment-l cf" id="comment-<?php comment_id(); ?>">
			<header class="comment-meta vcard">
			</header>
			<div class="press-comment-l--avatar">
		    <div id="" class="comment-avatar">
		      <div class="comment-circle-e" style="background-image:url(<?php echo get_avatar_url(get_avatar( $comment, 64)); ?>);"></div>
		      <div class="comment-avatar--text"><?php echo get_comment_author_link() ?></div>
		    </div>
		  </div>
